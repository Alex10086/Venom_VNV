...
struct VisionTargetConfig
{
  ...
  bool robust_candidate_enabled{false};
  ...
  std::vector<double> target_position_candidate_offsets;
  std::vector<double> orientation_candidate_offsets;
  std::vector<double> grasp_forward_probe_distance_candidates;
  std::vector<double> pregrasp_distance_candidates;
  double empty_grasp_retreat_backoff{0.03};
  double empty_grasp_retreat_up{0.03};
  bool refresh_target_after_empty_grasp{true};
  XYZ refresh_retry_target_position_bias{0.015, 0.0, 0.010};
  double empty_grasp_target_refresh_timeout_sec{1.5};
  double refresh_same_object_max_xy_delta{0.10};
  double refresh_same_object_max_xyz_delta{0.10};
  double refresh_same_object_max_z_delta{0.045};
  int64_t max_empty_grasp_target_refresh_count{2};
  int64_t max_visual_pick_candidates{5};
...
struct ClassificationPlaceConfig
{
  ...
  std::vector<XYZ> pick_candidate_offsets{{0.0, 0.0, 0.0}};
  bool move_home_before_platform_pick{false};
  bool use_direct_pregrasp_joint_approach{true};
  double direct_pregrasp_approach_lift_z{0.04};
  double direct_pregrasp_joint_duration_sec{3.0};
  double direct_pregrasp_joint_goal_time_tolerance_sec{8.0};
  std::vector<RPY> release_orientation_candidate_offsets{{0.0, 0.0, 0.0}};
  std::vector<XYZ> release_candidate_offsets{{0.0, 0.0, 0.0}};
  bool adaptive_release_candidates_enabled{true};
  double adaptive_release_nominal_xy_radius{0.46};
  double adaptive_release_backoff_step{0.04};
  double adaptive_release_max_backoff{0.12};
  double adaptive_release_lift_step{0.03};
  double adaptive_release_max_lift{0.09};
...
struct TaskParameters
{
  ...
  bool prefer_direct_arm_trajectory_execution{false};
  double arm_trajectory_goal_time_tolerance_sec{8.0};
  double arm_trajectory_result_timeout_padding_sec{8.0};
